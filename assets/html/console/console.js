...
function showhelp() {
  var commands = [
    ...
    '      load also supports shortcuts, like jquery or lodash: eg. :load jquery',
    ':load &lt;url&gt; - to inject new DOM',
	':service - create a microservice endpoint for this page',
    ':clear or :c - to clear the history (accessed using cursor keys)',
    ':history - list current session history',
    ':about',
    '$_ for last value',
    '',
    "<p>To inject JS Console, bookmark this: <a href=\"javascript:window.open(%22about:blank%22).document.write(%22%3Cbody%3E%3Cscript%20onload='window.page=opener'%20src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/1674766/inject.js'%3E%3C/script%3E%3Cbody%3E%22);\">Inject Console</a>.</p>",
	"<p>For more details on this console, check out my article <a target=_blank href='https://hackernoon.com/universal-javascript-console-for-browser-electron-nw-js-node-js-and-windows-272e4bd6f9d9'>Universal Console</a></p>",
	"<p>For more details on using the :service command, check out my article <a target=_blank href='https://hackernoon.com/turn-any-website-into-a-microservice-serverless-endpoint-4a12446ede7'>:service Article</a></p>",
    '',
...
var exec = document.getElementById('exec'),
    ...
    pos = 0,
    libraries = {
      paper : 'https://assets.codepen.io/1674766/paper-full.js',
      underscore : 'https://assets.codepen.io/1674766/underscore.js',
      backbone : 'https://assets.codepen.io/1674766/backbone.js',
      localforage : 'https://assets.codepen.io/1674766/localforage.js',
      parsejs : 'https://assets.codepen.io/1674766/parse-js.js'
